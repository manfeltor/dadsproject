"""
Django settings for dadsproject project.
...
ROOT_URLCONF = 'dadsproject.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [ BASE_DIR / "startbootstrap-sb-admin-2-gh-pages" ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'dadsproject.wsgi.application'
